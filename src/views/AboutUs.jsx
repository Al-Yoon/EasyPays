    ...
    <div>
        ...
        <div className="w-full bg-white text-black py-16 px-4">
            <div className="max-w[1240px] mx-auto grid md:grid-cols-2">
                <img className="w-[1000px] mx-auto " src={AboutImg} alt="/"></img>
                        <div className="flex flex-col pl-4 justify-center">
                            <p className="text-[#38bdf8] md:text-1xl sm:text-3xl text-2xl font-bold text-center">Sobre nosotros</p>
                                <h1 className="text-black md:text-1xl sm:text-6xl text-4xl font-bold md:py-3 text-center">Conócenos mejor</h1>
                                    <div className="bg-[#38bdf8] rounded-xl my-10 text-black md:text-1xl sm:text-1xl text-xl py-5 px-5">
                                    <p>
            ...
            <div className="w-full bg-white text-black py-16 px-4">
                <div className="max-w[1240px] mx-auto gap-5 grid md:grid-auto">
                            ...
                            <div className="px-4 mx-auto justify-center w-3/4 mt-5 ">
                                    <h1 className="text-black md:text-1xl sm:text-5xl text-4xl font-bold md:py-3 text-center">Misión</h1>
                                        <div className="bg-[#38bdf8] rounded-xl my-10 text-black md:text-1xl sm:text-1xl text-xl py-5 px-5">
                                        <p>
                            ...
                            <hr></hr>
                            <div className="pl-4 mx-auto justify-center w-3/4">
                                    <h1 className="text-black md:text-1xl sm:text-5xl text-4xl font-bold md:py-3 text-center">Visión</h1>
                                        <div className="bg-[#38bdf8] rounded-xl my-10 text-black md:text-1xl sm:text-1xl text-xl py-5 px-5">
                                        <p>
