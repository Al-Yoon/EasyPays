    ...
    return (
        <div className="text-white bg-black">
            <div className="max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center p-5">
                ...
                <p className="border-b border-white w-[180px] font-medium mx-auto">Ya tienes una cuenta?</p>
            </div>
            ...
            <div className="w-full bg-white text-black py-16 px-4">
                <div className="max-w[1240px] mx-auto grid md:grid-cols-2">
                    ...
                    <div className="flex flex-col pl-4 justify-center">
                        ...
                        <h1 className="text-black md:text-1xl sm:text-6xl text-4xl font-bold md:py-3"> Somos la mejor aplicación de todo el mundo</h1>
                        ...
                        <Link to="/nosotros"><button className="bg-[#38bdf8] w-[200px] rounded-md font-medium my-6 mx:auto md:mx-0 py-3 text-black  hover:bg-gray-400 duration-500">Conocer más</button></Link>
                    </div>
                </div>
            </div>
            ...
            <div id="services" className="w-full py-[10rem] bg-white px-4 text-black">
                ...
                <div className="max-w-auto mx-auto grid md:grid-cols-3 gap-8 pl-5 pr-5">
                    ...
                    <div className='w-[20] shadow-2xl bg-white flex flex-col p-4 md:my-0 my-8 text-black rounded-lg items-center'>
                        ...
                        <h2 className='text-2xl font-bold text-center py-8'>Historial y Reportes</h2>
